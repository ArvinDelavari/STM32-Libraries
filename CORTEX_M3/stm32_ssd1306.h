 ...
 * @param  *Font: Pointer to @ref FONT_t structure with used font
 * @param  color: Color used for drawing. This parameter can be a value of @ref SSD1306_COLOR_t enumeration
 * @retval Character written
 */
char SSD1306_Putc(char ch, FONT_t* Font, SSD1306_COLOR_t color);
 ...
 */
char SSD1306_Puts(char* str, FONT_t* Font, SSD1306_COLOR_t color);
